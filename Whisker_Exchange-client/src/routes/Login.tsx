...
export const Login: React.FC = () => {
    return (
        <div className="h-screen flex flex-col items-center justify-center text-center">
            <h1 className="text-xl lg:text-2xl font-bold">Sign in to your account</h1>
            <p>Or <a className="text-cyan-300" href='/register'>create an account</a></p>
            <form className="lg:w-1/3" method="POST">
